...
<body>
    ...
    <div class="vh-100 d-flex-col justify-content-center login-container" style="padding-top:15vh;  overflow: hidden;  background: url(assets/bg.jpeg) no-repeat;
    background-size: cover;">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center mb-3">
                <h2 class="heading-section"><img src="assets/logo.png" height="131" alt=""></h2>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="login-wrap p-0">
                    <h3 class="mb-4 text-center">Hostel Management System</h3>
